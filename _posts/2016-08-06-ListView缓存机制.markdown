...
![1](https://ooo.0o0.ooo/2016/08/06/57a614835488f.jpg)
![2](https://ooo.0o0.ooo/2016/08/06/57a6140c57029.jpg)
![3](https://ooo.0o0.ooo/2016/08/06/57a61483b0404.jpg)

{% highlight ruby linenos %}
08-07 00:49:12.457 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is null
08-07 00:49:12.547 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is null
08-07 00:49:12.551 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is null
08-07 00:49:12.554 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is null
08-07 00:49:19.539 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is null
08-07 00:49:28.843 11156-11156/com.guoyonghui.listviewlearning D/MainActivity: convertView is not null
{% endhighlight %}

1. 在左边的图片中，从控制台输出可以看到，加载前四张图片时convertView均为null
2. 在中间的图片中，第五张图片已经滑入，但由于第一张图片还未滑出屏幕，因此此时没有任何视图被加入到mScrapViews，因此加载第五张图片的时候从控制台输出可以看到convertView仍为null
3. 在右边的图片中，在第六张图片滑入的时候，第一张图片已经完全滑出，因此第一张图片对应的视图会被加入到mScrapViews中用来进行复用，因此在加载第六张图片的时候我们首先看到的是之前被缓存的第一张图片，从控制台输出也可以看到此时convertView已经不为null了

通过这个例子很好的对ListView的缓存机制进行了说明，经过分析，我们现在已经可以很容易地知道：

> ListView用来展示列表需要创建的子视图的个数最多为第一屏的子视图的个数加一。
